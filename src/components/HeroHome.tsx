  ...
  return (
    <section className="relative max-w-6xl mx-auto px-6 py-24 md:py-32 flex flex-col-reverse md:flex-row items-center gap-12 md:gap-24 overflow-hidden">
      <div className="w-full md:w-1/2 flex flex-col items-start z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-wlnb-beige/50 border border-wlnb-beige mb-6 transition-all hover:bg-wlnb-beige/70 hover:border-wlnb-accent/30">
        ...
        <div className="flex flex-col gap-4 w-full max-w-md p-5 rounded-2xl bg-wlnb-light border border-wlnb-beige mb-10 transition-all hover:bg-wlnb-beige/40 hover:border-wlnb-accent/30">
          <div className="flex items-start gap-3">
            <div className="mt-0.5 text-wlnb-accent">📅</div>
            <div>
              <p className="text-sm font-medium text-wlnb-brown">May 3, 2026</p>
              <p className="text-xs text-wlnb-tan mt-0.5">3:00 PM - 6:00 PM</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <div className="mt-0.5 text-wlnb-accent">📍</div>
            <div>
              <p className="text-sm font-medium text-wlnb-brown">Berkeley, CA</p>
              <p className="text-xs text-wlnb-tan mt-0.5">2603 Ellsworth St. Backyard</p>
            </div>
          </div>
        </div>
      </div>
